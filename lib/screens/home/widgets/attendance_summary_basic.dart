    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(
            width: 2,
            color:
                ThemeProvider.currentThemeData!.primaryColor.withOpacity(0.2)),
              ...
              BarChartData(
                ...
                titlesData: FlTitlesData(
                  ...
                  bottomTitles: SideTitles(
                    showTitles: true,
                    getTitles: (double value) => getBottomTitle(data, value),
                  ),
                ),
                axisTitleData: FlAxisTitleData(
                  show: true,
                  bottomTitle:
                      AxisTitle(titleText: "Day", showTitle: true, margin: 10),
                  leftTitle: AxisTitle(
                      titleText: "Hour", showTitle: true, margin: -25),
                ),
